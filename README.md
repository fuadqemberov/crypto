...
## Balans və giriş filtrləri — 2026-09-14
Əsas kart sərbəst cash göstərir. Cüzdan = sərbəst cash + açıq marja; equity = cüzdan + mark üzrə açıq PnL. Marjanı həm cash-dən, həm cüzdandan çıxmaq ikiqat sayma olardı. 2,000 USD equity, 7% allocation və 3× leverage ilə təxminən 140 USD marja + 0.21 USD giriş komissiyası ayrılır, sərbəst cash təxminən 1,859.79 USD qalır (lot yuvarlaqlaşdırması nəzərə alınmalıdır). Mövqe bağlananda marja cash-ə qaytarılır və nəticə əlavə edilir. 1,995 USD cüzdan öz-özlüyündə orderin 5 USD marja ilə açılması demək deyil.

RSI üçün 15m/1h rejimləri məcburidir, son 15m RSI dəyişməsi istiqamətə əks olmamalıdır. MACD line, signal, histogram və histogram dəyişməsi paneldə göstərilir; 15m histogram istiqamətə doğru güclənməli, 1h isə əks zəifləməməlidir. Bunlar yeni giriş heuristikalarıdır, gəlirlilik sübutu deyil.

Dəstək/müqavimət son 120 şam daxilində hər iki tərəfdə iki bağlanmış şamla təsdiqlənən pivotlardan götürülür. 15m/1h/4h daxilində ən yaxın aşağı dəstək və yuxarı müqavimət seçilir. LONG üçün müqavimətə, SHORT üçün dəstəyə qədər ən azı 2R + 0.25 ATR məsafə olmalıdır; broker bunu faktiki giriş qiymətində yenidən yoxlayır. TP/SL hələ ATR əsaslıdır. Uyğun pivot yoxdursa səviyyə naməlumdur; bu maneəsiz bazar zəmanəti deyil. Cari bağlanmış şamdan sonrakı məlumat istifadə olunmur.

Bu düzəliş üçün pivot, momentum, sərbəst balans və broker giriş testləri əlavə olunub. Hazırlanan mühitdə Java runtime əlçatan olmadığından bu reviziyanın Maven testləri icra edilməyib. Lokal yoxlama: `mvn verify` və ya `build.cmd`. Mövcud hesab tarixçəsini silməyin.
